...
// Define props for ChartCard
interface ChartCardProps {
  title: string;
  description?: string;
  chartType: "doughnut" | "bar" | "line" | "radar";
  data: any; // Replace with specific Chart.js types if needed
  height?: string;
}
...
const Dashboard = () => {
  ...
  // Explicitly type the MouseEvent
  ...
  const StatCard: React.FC<StatCardProps> = ({
    ...
    const getColorClass = (gradientClass: string): string => {
    ...
    return (
      ...
      >
        ...
        <div className="flex items-end gap-3 mb-1">
          ...
          {trend && percentage && (
            <div
              className={`flex items-center mb-1 ${trend === "up" ? "text-green-400" : "text-red-400"
                }`}
            >
              {trend === "up" ? (
                <svg
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M12 7a1 1 0 01-1 1H9a1 1 0 01-1-1V6a1 1 0 011-1h2a1 1 0 011 1v1zm-6 6a1 1 0 011-1h2a1 1 0 011 1v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-1zm8-6a1 1 0 00-1 1v4a1 1 0 001 1h2a1 1 0 001-1V8a1 1 0 00-1-1h-2z"
                    clipRule="evenodd"
                  />
                </svg>
              ) : (
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M12 13a1 1 0 01-1 1H9a1 1 0 01-1-1v-1a1 1 0 011-1h2a1 1 0 011 1v1zm-6-6a1 1 0 011-1h2a1 1 0 011 1v1a1 1 0 01-1 1H7a1 1 0 01-1-1V7zm8 6a1 1 0 00-1-1h-2a1 1 0 00-1 1v1a1 1 0 001 1h2a1 1 0 001-1v-1z"
                    clipRule="evenodd"
                  />
                </svg>
              )}
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(145deg, rgba(255,255,255,0.2) 0%, rgba(255,255,255,0) 50%, rgba(255,255,255,0) 100%)",
            borderRadius: "16px",
          }}
        />
      </motion.div>
  ...
  const ChartCard: React.FC<ChartCardProps> = ({
    ...
    // Define glow variants for the hover effect
      ...
      >
        ...
        <div className={`${height} w-full relative`}>
          ...
          <motion.div
            ...
            initial="initial"
            animate={hoveredCard === title ? "hover" : "initial"}
          />
        </div>
          ...
          {isLoaded ? (
            ...
            >
              ...
              <motion.div variants={headerVariants} className="text-center mb-12">
                <motion.h1
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, #10B981, #3B82F6, #8B5CF6, #EC4899)",
                ...
                <p className="text-gray-400 max-w-lg mx-auto">
                  Overview statistik dan performa terkini, diupdate secara
                  real-time untuk membantu pengambilan keputusan yang lebih baik.
                </p>
              </motion.div>
              ...
              >
                <p>
                  Dashboard diperbarui terakhir: {new Date().toLocaleString()}
                </p>
              </motion.div>
            </motion.div>
          ) : (
            ...
            >
              ...
              >
                ...
                <p className="mt-4 text-xl font-medium text-blue-400">
                  Loading Dashboard...
                </p>
              </motion.div>
            </motion.div>
